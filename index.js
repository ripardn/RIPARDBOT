...
/////////////////
const BotName = 'ripardn BOT'; 
const instagram = 'https://www.instagram.com/ripardn/'; 
const telegram = 'JANGAN TELE GW BUAT BOKP DOANG'; 
const kapanbotaktif = 'SETIAP KAMU ON :*'; 
const youtube = 'kepo';
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@ripardn')
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by ig:@ripardn`)
})
